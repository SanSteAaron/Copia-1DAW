...
namespace Ejercicio706
{
    public partial class FGestionProfesores : Form
    {
        ...
        private void BIntroducirProfesor_Click(object sender, EventArgs e)
        {
            ...
            {
                listaProfesores.Añadir_Profesor(name, dni, phone, tutorcode);
            }
            else
            {
        ...
        {
            string name = (Interaction.InputBox("Introduce el nombre del profesor:"));
            if (listaProfesores.Eliminar_Profesor(name) == true)
            {
        ...
        {
            MessageBox.Show(listaProfesores.Mostrar_Lista_Profesores());
        }

        private void BOrdenarProfesores_Click(object sender, EventArgs e)
        {
            listaProfesores.Ordenar_Lista_Profesores();
        }

        private void BMostrarDatosProfesor_Click(object sender, EventArgs e)
        {
            string name = (Interaction.InputBox("Introduce el nombre del profesor:"));
            MessageBox.Show(listaProfesores.Mostrar_Profesor(name));
        }
        ...
        private void BAñadirAsignatura_Click(object sender, EventArgs e)
        {
            ...
            if (listaProfesores.Añadir_Asignaturas_Profesor(name, subject) == true)
            {
        ...
        {
            string name = (Interaction.InputBox("Introduce el nombre del profesor:"));
            if (listaProfesores.Eliminar_Asignaturas_Profesor(name) == true)
            {
        ...
        {
            string subject = (Interaction.InputBox("Introduce la asignatura:"));
            MessageBox.Show(listaProfesores.Mostrar_Profesores_Asignatura(subject));
        }
    }
}
