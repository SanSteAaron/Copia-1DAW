...
namespace Ejercicio805
{
    public partial class FGestionAlumnos : Form
    {
        ...
        private void BIntroducirAlumno_Click(object sender, EventArgs e)
        {
            ...
            {
                listaPersonas.Añadir_Alumno(name, dni, phone, cursocode);
            }
        }
        ...
        {
            string name = (Interaction.InputBox("Introduce el nombre del alumno:"));
            if (listaPersonas.Eliminar_Alumno(name) == true)
            {
        ...
        {
            MessageBox.Show(listaPersonas.Mostrar_Lista_Alumnos());
        }

        private void BOrdenarAlumnos_Click(object sender, EventArgs e)
        {
            listaPersonas.Ordenar_Lista_Alumnos();
        }
        ...
        private void BMostrarListaAlumnosCurso2_Click(object sender, EventArgs e)
        {
            ...
            if (listaCursos.Buscar_Curso(cursocode) >= 0)
                MessageBox.Show(listaPersonas.Mostrar_Alumnos_Curso(cursocode));
            else
        ...
        private void BMostrarDatosAlumno_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(listaPersonas.Mostrar_Alumno(name));
        }
        ...
        private void BAñadirNotas_Click(object sender, EventArgs e)
        {
            ...
            if (listaPersonas.Añadir_Notas_Alumno(name,grade) == true)
            {
        ...
        {
            string name = (Interaction.InputBox("Introduce el nombre del alumno:"));
            if (listaPersonas.Eliminar_Notas_Alumno(name) == true)
            {
        ...
        {
            MessageBox.Show(listaPersonas.Mostrar_Alumnos_Aprobados());
        }

        private void BMostrarSuspendidos_Click(object sender, EventArgs e)
        {
            MessageBox.Show(listaPersonas.Mostrar_Alumnos_Suspendidos());
        }
    }
}
